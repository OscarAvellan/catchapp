 ...
 * Edited by Dalzy on 13/10/2017.
 */

public class LogInRequest extends AsyncTask<Triplet, String, Boolean> {

    public static final int CONNECTION_TIMEOUT=10000;
    public static final int READ_TIMEOUT=15000;

    private static final String ID_TOKEN = "idToken"; // needs to be reflected correctly in NHandler
                                                      // but just hardcoded atm
    ...
    protected Boolean doInBackground(Triplet... params){
        ...
        try{
            ...
            conn = setConnParameters((String) ttp1.geturl(), q.getString(ID_TOKEN));
    ...
    private HttpURLConnection setConnParameters(String s_url, String idToken){
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "Token" + idToken);
